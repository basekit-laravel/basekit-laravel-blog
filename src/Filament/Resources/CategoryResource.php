...
use BackedEnum;
use BasekitLaravel\BasekitLaravelBlog\Filament\Resources\CategoryResource\Pages;
...
class CategoryResource extends Resource
{
    ...
    {
        return __('basekit-laravel-blog::basekit-laravel-blog.category');
    }

    public static function getPluralModelLabel(): string
    {
        return __('basekit-laravel-blog::basekit-laravel-blog.categories');
    }
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('locales')
                    ...
                    ->badge()
                    ->getStateUsing(fn (Category $record): array => $record->translations->pluck('locale')->all())
                    ->toggleable(),
