...
This repository is a Laravel package: `basekit-laravel-blog` — Basekit Laravel Blog is a reusable, optional feature package for publishing and rendering blog posts on Basekit-powered Laravel websites..

It targets PHP ^8.3|^8.4|^8.5 and Laravel ^13 and is distributed on Composer as
`basekit-laravel/basekit-laravel-blog`. The canonical agent instructions live in `AGENTS.md` — if you
