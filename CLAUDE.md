...
This repository contains a Laravel package (`basekit-laravel-blog`) that provides
`Basekit Laravel Blog is a reusable, optional feature package for publishing and rendering blog posts on Basekit-powered Laravel websites.`. The canonical project instructions live in `AGENTS.md` and always take
